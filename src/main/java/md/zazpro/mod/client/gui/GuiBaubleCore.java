...
public class GuiBaubleCore extends GuiContainer
{
    ...
    public GuiBaubleCore(InventoryPlayer p_i47233_1_, ItemStack itemStack)
    {
        super(new ContainerShulkerBox(p_i47233_1_, itemStack, Minecraft.getMinecraft().player));
